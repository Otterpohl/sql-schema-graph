...
BEGIN
    ...
    SET @sql = 'INSERT INTO #dependencies 
...
FETCH NEXT FROM dependency_cursor INTO @referenced_database, 
									   @referenced_schema, 
									   @referenced_object_name

WHILE @@FETCH_STATUS = 0  
BEGIN  
	SET @sql = 'SELECT @object_type = CASE o.type_desc 
...
WHERE referencing_Database <> referenced_Database
	AND (referencing_schema <> 'sys' OR referenced_schema <> 'sys')
